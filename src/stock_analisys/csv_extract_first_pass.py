...
from packages.bastter_class import BastterStocks


def main(index):

    """
    Grabs de CSV filese for all the 4700 stocks in Bastter Site 
    """ 
    # Time for avoiding conflicts between passes
    time.sleep(random.uniform(0.1,10))
    
    # Stock Selection
    csv_stocks_original = pd.read_csv('data/listas_originais/[4K] - bastter_original.csv')
